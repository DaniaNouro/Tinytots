...
class StudentSearchSortController extends Controller
{
...
/*_________________________________________________________________________________________________________________*/
         ...
         $users=$this->UserSearchRepository->searchByName($name,'Student');
         if ($users->isEmpty()) {
...
/*_________________________________________________________________________________________________________________*/
     public function sortAcs($id){
        $data=$this->UserSortRepository->sortAcs($id,'Student');
        return Response::Success($data, 'success', 200);
     }
/*_________________________________________________________________________________________________________________*/
     public function sortDesc($id){
         $data=$this->UserSortRepository->sortDesc($id,'Student');
         return Response::Success($data, 'success', 200);
      }
}
